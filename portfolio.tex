...
\begin{itemize}[leftmargin=0pt, label={}]
    ...
    \item \textbf{Lua} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{VimScript} \hfill \tikz{\foreach \x in {1,...,3} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \foreach \x in {4,...,5} {\draw[primaryblue] (\x*0.4-0.3,0) circle (0.15);}}
    \item \textbf{C\#} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{Java} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{AppleScript} \hfill \tikz{\foreach \x in {1,...,3} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \foreach \x in {4,...,5} {\draw[primaryblue] (\x*0.4-0.3,0) circle (0.15);}}
\end{itemize}
...
\begin{itemize}[leftmargin=0pt, label={}]
    ...
    \item \textbf{D3.js} \hfill \tikz{\foreach \x in {1,...,3} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \foreach \x in {4,...,5} {\draw[primaryblue] (\x*0.4-0.3,0) circle (0.15);}}
    \item \textbf{TailwindCSS} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{libpcap} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{BPF} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{GraphQL} \hfill \tikz{\foreach \x in {1,...,3} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \foreach \x in {4,...,5} {\draw[primaryblue] (\x*0.4-0.3,0) circle (0.15);}}
    \item \textbf{OpenAI API} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{libgit2} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{Tree-sitter} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{SQLite} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{Redis} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{Coqui TTS} \hfill \tikz{\foreach \x in {1,...,3} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \foreach \x in {4,...,5} {\draw[primaryblue] (\x*0.4-0.3,0) circle (0.15);}}
    \item \textbf{Speech Recognition} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{Flask} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{MySQL} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{fsnotify} \hfill \tikz{\foreach \x in {1,...,3} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \foreach \x in {4,...,5} {\draw[primaryblue] (\x*0.4-0.3,0) circle (0.15);}}
    \item \textbf{Tesseract OCR} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{CoreData} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{Screen Time API} \hfill \tikz{\foreach \x in {1,...,3} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \foreach \x in {4,...,5} {\draw[primaryblue] (\x*0.4-0.3,0) circle (0.15);}}
    \item \textbf{DOTween} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{LWJGL} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{Box2D Physics} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{WebSockets} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{Heroku} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{xterm.js} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
    \item \textbf{UIKit} \hfill \tikz{\foreach \x in {1,...,4} {\fill[primaryblue] (\x*0.4-0.3,0) circle (0.15);} \draw[primaryblue] (5*0.4-0.3,0) circle (0.15);}
\end{itemize}
\end{multicols}
